...
public interface LjmdocPrinsetup extends JpaRepository<LjmDocprintSetup, Long> {
	...
	@Query("SELECT t.DPS_TEMP_LOC FROM LjmDocprintSetup t WHERE t.DPS_TEMPLATE_NAME = :docTemplateName")
    Optional<String> findFileLocationByTemplateName(@Param("docTemplateName") String templateName);
}